...
INSERT INTO `playlist` VALUES (1,'Raga of autumn '),(2,'Raga of Vasant'),(3,'Raga of varsha'),(23,'my playlist'),(24,'Raga of Malkauns'),(25,'Raga of Brindavani sarang');
...
CREATE TABLE `songlist` (
  ...
  `songlist_singer` varchar(45) DEFAULT NULL,
  `songlist_taal` varchar(45) DEFAULT NULL,
  `songlist_composer` varchar(45) DEFAULT NULL,
  `songlist_raaga` varchar(45) DEFAULT NULL,
...
INSERT INTO `songlist_playlist_mapping` VALUES (3,1),(8,1),(8,2),(3,3),(9,3);
...
INSERT INTO `student` VALUES ('ramprasad','MT2015015','default','ramprasad'),('Jack','MT2015078','default','default'),('Ramanna','MT2015098','default','ramanna'),('gunjan','MT2016001','default','gunjan'),('john','MT2016004','default','default');
...
CREATE TABLE `student_song_assignment` (
  ...
  CONSTRAINT `fk_student_song_assignment_2` FOREIGN KEY (`playlist_id`) REFERENCES `playlist` (`playlist_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `student_song_assignment` VALUES (1,'MT2016004',NULL,1,'2017-09-06 08:51:35'),(2,'MT2016004',NULL,2,'2017-09-06 08:52:17'),(3,'MT2015078',NULL,2,'2017-09-06 09:34:04'),(4,'MT2016004',NULL,3,'2017-09-11 14:15:14'),(5,'MT2015078',NULL,3,'2017-09-11 14:15:14');
